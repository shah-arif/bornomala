import 'package:bornomala/bloc/greeting.dart';
import 'package:bornomala/const/app_color.dart';
import 'package:bornomala/const/app_string.dart';
import 'package:bornomala/drafts/home_screen_draft.dart';
...
class AnimatedEnv extends StatefulWidget {
  @override
  State<AnimatedEnv> createState() => _AnimatedEnvState();
}

class _AnimatedEnvState extends State<AnimatedEnv> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return AnimatedPositioned(
        top: drawer.value == false ? 0 : MediaQuery.of(context).size.height*0.1,
        bottom: drawer.value == false ? 0 : MediaQuery.of(context).size.height*0.1,
        left: drawer.value == false ? 0 : MediaQuery.of(context).size.width*0.4,
        right: drawer.value == false ? 0 : MediaQuery.of(context).size.width*-0.4,
