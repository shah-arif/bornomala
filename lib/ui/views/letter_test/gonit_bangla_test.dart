...
class GonitBanglaTest extends StatefulWidget {
  const GonitBanglaTest({Key? key}) : super(key: key);

  @override
  State<GonitBanglaTest> createState() => _GonitBanglaTestState();
}

class _GonitBanglaTestState extends State<GonitBanglaTest> {
  //AudioPlayer
  ...
  Widget build(BuildContext context) {
    Map map = AppMap().gonit_bangla_map;
