...
class GonitEnglishTest extends StatefulWidget {
  const GonitEnglishTest({Key? key}) : super(key: key);

  @override
  State<GonitEnglishTest> createState() => _GonitEnglishTestState();
}

class _GonitEnglishTestState extends State<GonitEnglishTest> {
  //AudioPlayer
  ...
  Widget build(BuildContext context) {
    Map map = AppMap().gonit_english_map;
