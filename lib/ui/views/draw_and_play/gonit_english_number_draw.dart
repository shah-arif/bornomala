...
class GonitEnglishNumberDraw extends StatefulWidget {
  GonitEnglishNumberDraw({Key? key}) : super(key: key);

  @override
  State<GonitEnglishNumberDraw> createState() => _GonitEnglishNumberDrawState();
}

class _GonitEnglishNumberDrawState extends State<GonitEnglishNumberDraw> {
  ...
  Widget build(BuildContext context) {
    RxString display = AppList.english_number.first.obs;
                ...
                itemBuilder: (context, index) => Padding(
                  ...
                  child: Container(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: (){
                            display.value = AppList.english_number[index];
