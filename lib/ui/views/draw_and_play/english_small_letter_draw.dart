...
class EnglishSmallLetterDraw extends StatefulWidget {
  EnglishSmallLetterDraw({Key? key}) : super(key: key);

  @override
  State<EnglishSmallLetterDraw> createState() => _EnglishSmallLetterDrawState();
}

class _EnglishSmallLetterDrawState extends State<EnglishSmallLetterDraw> {
  ...
  Widget build(BuildContext context) {
    RxString display = AppList.small_letter.first.obs;
                ...
                itemBuilder: (context, index) => Padding(
                  ...
                  child: Container(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: (){
                            display.value = AppList.small_letter[index];
